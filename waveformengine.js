...
// Replace WaveformPlaylist.init with WaveSurfer
function initWaveSurfer(container, options = {}) {
  const defaultOptions = {
    ...
    plugins: [
      WaveSurfer.timeline.create({
        container: `#${container.id}-timeline`
      }),
...
// Replace existing playlist initializations
// Example for importPlayer:
importPlayer = initWaveSurfer(document.getElementById("newImportTrack"), {
  height: 200,
  cursorColor: 'red',
  waveColor: 'black'
});
