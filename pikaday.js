...
}(this, function (moment)
{
    ...
    renderDay = function(opts)
    {
        ...
        if (opts.isEmpty) {
            if (opts.showDaysInNextAndPreviousMonths) {
                ...
                return '<td class="is-empty" id="is-empty"></td>';
            }
        }
        if (opts.isDisabled) {
    ...
    renderTimePicker = function(num_options, selected_val, select_class, display_func, increment_by) {
        ...
        var disablestyle = "";
        if (select_class == "pika-select-minute" || select_class == "pika-select-second")
            disablestyle = "disabled";
        var to_return = '<td><select class="pika-select '+select_class+'"' + disablestyle + '>';
