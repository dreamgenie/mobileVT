    ...
    extend(WebAudioRecorder.prototype, {
      ...
      startRecording: function() {
        if (this.isRecording())
          ...
          // AUDIO WORKLET
          if (!scriptprocessor) {
            if (!this.recordWorkletProcessor) {
              globalAudioContext.audioWorklet.addModule('record-worklet-processor.js').then(()=>{
                this.recordWorkletProcessor = new AudioWorkletNode(
                  globalAudioContext,
                  'record-worklet-processor'
                )              
    
                this.processor = this.recordWorkletProcessor
                ...
                this.processor.port.onmessage = function (event) {
            ...
            this.processor = this.context.createScriptProcessor(
              this.options.bufferSize, this.numChannels, this.numChannels)            
