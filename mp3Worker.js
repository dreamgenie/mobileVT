mp3Worker_func = function() {
	...
	self.onmessage = function(e) {
		...
		case 'init':
			...
			Lame.set_in_samplerate(mp3codec, e.data.config.samplerate || 48000);
			Lame.set_out_samplerate(mp3codec, e.data.config.samplerate || 48000);
...
var mp3Worker = mp3Worker_func.toString().trim().match(
